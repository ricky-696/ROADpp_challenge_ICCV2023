...
class Swin_l_224(nn.Module):
    def __init__(self, num_class, num_channels, input_size=224, loc_output=4):
        ...
        self.classifier = nn.Linear(self.swin.num_features + loc_output, num_class)
    ...
    def forward(self, x, loc):
        ...
        # loc = self.mlp(loc)
        output = torch.cat((pooled_output, loc), dim=1)
